...
clear
echo "INICIANDO SETUP DO N8N 1.57.0 ..."
sleep 5
clear
sudo apt -y update
sudo apt -y upgrade
...
sudo docker run -d --restart unless-stopped --name n8n -p 5678:5678 -e N8N_SECURE_COOKIE=false -v ~/.n8n:/home/node/.n8n n8nio/n8n:1.57.0
